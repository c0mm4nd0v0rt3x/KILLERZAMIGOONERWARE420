if game.PlaceId == 8343259840 then
	local Success, Error = pcall(function()
		...
		local Framework                = loadstring(game:HttpGet("https://raw.githubusercontent.com/c0mm4nd0v0rt3x/KILLERZAMIGOONERWARE420/main/TestUI.lua", true))() -- https://raw.githubusercontent.com/JackHiggly/RobloxThings/main/TestUI
		local ESPFramework             = loadstring(game:HttpGet("https://raw.githubusercontent.com/c0mm4nd0v0rt3x/KILLERZAMIGOONERWARE420/main/ESP.lua", true))()
		local Watermark                = Framework:CreateWatermark("GoonerWare | {game} | {fps}")

		--if wlID[game.Players.LocalPlayer.UserId] then
		--GoonerWare                  = Framework:CreateWindow(Version, Vector2.new(550, 700)) -- 492, 588
		--else
		local GoonerWare                  = Framework:CreateWindow(Version, Vector2.new(492, 700)) -- 492, 588
		--end

		local Credits                  = GoonerWare:CreateTab("Settings")
		-- if wlID[game.Players.LocalPlayer.UserId] then
		-- 	Prem = GoonerWare:CreateTab("Premium")
		...
		-- 	end)
		-- end
		local General                  = GoonerWare:CreateTab("General")
		local Extra                    = GoonerWare:CreateTab("Extra")
		local Visuals                  = GoonerWare:CreateTab("Visuals")
		local TeleportsSS              = GoonerWare:CreateTab("Teleport Area")
		local TeleportsS               = GoonerWare:CreateTab("Teleports")
		...
		MainS:AddButton("Melee God Mode", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/c0mm4nd0v0rt3x/KILLERZAMIGOONERWARE420/main/meleegod.lua", true))()
		end)
