if game.PlaceId == 8343259840 then
	local Success, Error = pcall(function()
		...
		local Framework                = loadstring(game:HttpGet("https://raw.githubusercontent.com/NougatBitz/GoonerWare-Leak/main/TestUI.lua", true))() -- https://raw.githubusercontent.com/JackHiggly/RobloxThings/main/TestUI
		local ESPFramework             = loadstring(game:HttpGet("https://raw.githubusercontent.com/NougatBitz/GoonerWare-Leak/main/ESP.lua", true))()
		...
		MainS:AddButton("Melee God Mode", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/NougatBitz/GoonerWare-Leak/main/meleegod.lua", true))()
		end)
